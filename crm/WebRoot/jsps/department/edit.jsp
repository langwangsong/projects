...
<s:form id="form1" action="department_update" namespace="/" method="post" theme="simple">
	...
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	 ...
	 <tr>
	   ...
	   <tr>
	    <td width="10%"></td>
	    <td >
	    	<s:textarea name="description" cols="50" rows="5" value="%{model.description}"></s:textarea>
	    </td>
	  </tr>
	</table>
</s:form>
