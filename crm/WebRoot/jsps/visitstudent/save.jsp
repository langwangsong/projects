...
<s:form id="form1" action="visitStudent_save" method="post" namespace="/" theme="simple">
<table width="89%" class="emp_table"    style="margin-top:5px; margin-left:55px;" align="left" cellspacing="0">
  <tr>
    ...
    <td width="18%" align="left"><s:textfield name="sname"/></td>
    <td width="8%" align="left">联系地址：</td>
    <td width="19%" align="left"><s:textfield name="addr"/></td>
    <td width="7%" align="left">意向班级：</td>
    <td width="41%" align="left"><s:select list="list" name="classes.cid" listKey="cid" listValue="cname" headerKey="" headerValue="--请选择--"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left">性别：</td>
    <td align="left"><s:radio list="{'男','女'}" name="sex"/></td>
    <td align="left">学历：</td>
    <td align="left"><s:select list="{'博士','硕士','本科','大专','高中'}" name="education" headerKey="" headerValue="--请选择--" /></td>
  </tr>
  <tr>
    <td height="27">备注：</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="77">&nbsp;</td>
    <td colspan="5"><s:textarea cols="60" rows="5" name="bak" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
