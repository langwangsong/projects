		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0" id="table2">
			<tr>
				...
				<table border="0" width="145" id="table7" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="150" height="35"><p align="right"><font color="#FFFFFF">欢迎您：<s:property value="#session.existEmployee.ename"/><b></b></font></td>
					</tr>
				</table>
				</div>
				</td>
						...
						<div align="right">
							<table border="0" width="100%" cellspacing="0" cellpadding="0" id="table5">
								<tr>
									...
									<td width="189"> <font color="#ffffff">今天是：2008年10月10日</font></td>
								</tr>
							</table>
						</div>
						</td>
