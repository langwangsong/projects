...
<HTML>
	...
	<body>
		<br>
		<s:form namespace="/user" action="findByCondition">
						...
						<td>
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									...
									<td class="ta_01" bgColor="#ffffff">
										<s:select name="sex" list='{"男","女"}' headerKey="" headerValue="--请选择--"></s:select>
									</td>
								</tr>
								<tr>
									<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									...
									<td class="ta_01" bgColor="#ffffff">
										<s:select name="filename"  list='#{"true":"有","false":"没有" }' headerKey="" headerValue="--请选择--"></s:select>
									</td>
								</tr>
								<tr>
							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator value="users">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<s:a  namespace="/user" action="delete">
													<s:param name="userID" value="userID"></s:param>
