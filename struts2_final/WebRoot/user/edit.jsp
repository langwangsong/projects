			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<s:textfield name="logonName" ccssClass="bg"></s:textfield>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:select name="education" list='{"博士","硕士","研究生","本科","专科","高中"}' headerKey="" headerValue="--请选择--"></s:select>
					</td>
				</tr>
				<tr>
					<td align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff">
						<s:textfield id="birthday" readonly="readonly" size="20" name="birthday"></s:textfield>
					</td>
					<td align="center" bgColor="#f5fafe" class="ta_01">
						电话：
					</td>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colSpan="3">
						...
						<input type="button" value="重新上传" onclick="reupload()" />
						<div id="d1" style="display:none">
							<s:file name="upload" size="30"></s:file>
							<input type="button" value="取消" onclick="cancelreupload()"/>
						</div>
					</td>
				</tr>
				<TR>
