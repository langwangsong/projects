									...
									<tr>
										<td width="30%">
											...
											<div class="divbookcover">
												<p><img src="#" width="213" height="269" border="0" /></p>
											</div>

											<div style="text-align:center; margin-top:25px">
												<a href="${ pageContext.request.contextPath }/addCart?id=${ p.id }"> <img src="images/buybutton.gif" border="0" /></a>
											</div>
										</td>
